...
# Create New Text
@main_bp.route('/text/new', methods=['GET', 'POST'])
@login_required
def new_text():
...
@main_bp.route('/text/<int:text_id>/lists', methods=['GET', 'POST'])
@login_required
...
@main_bp.route('/list/<int:list_id>/add-item', methods=['GET', 'POST'])
@login_required
...
@main_bp.route("/list/<int:list_id>/edit", methods=["GET", "POST"])
@login_required
...
@main_bp.route('/item/<int:item_id>/delete')
@login_required
...
@main_bp.route('/text/<int:text_id>/read', methods=['GET', 'POST'])
@login_required
...
@main_bp.route('/training-list/<int:list_id>/delete', methods=['POST'])
@login_required
